...
// Favorite Widget
// #########################################################################################
class FavoriteBroadcast extends StatelessWidget {
  FavoriteBroadcast({super.key});
  ...
  List<BroadcastAttribute> broadcastData = [
    ...
    BroadcastAttribute(
      ...
      subtitle: 'Genre: Anime, Romance, Comedy',
